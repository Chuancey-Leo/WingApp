...
import org.wing.wapp.Status;
import org.wing.wapp.StatusService;
import org.wing.wapp.StatusUtils;
import org.wing.wapp.ui.base.BaseListAdapter;
import org.wing.wapp.ui.base.ViewHolder;
...
public class StatusListAdapter extends BaseListAdapter<Status> {
  ...
  public View getView(int position, View conView, ViewGroup parent) {
    ...
    if (detail.get(Initialization.LIKES) != null) {
      likes = (List<String>) detail.get(Initialization.LIKES);
    } else {
